...
$(document).ready(function(){
    ...
    */
    ...
    $(document).on('click','.btn-slider-header', function( e ){
        ...
        //va hacia abajo y abre el formulario
...
function initSliderHeader() {
    ...
    var flechaIzqHtml = '<picture><source srcset="'+baseUrl+'/assets/images/flecha-rosa.svg" type="image/svg+xml"><source srcset="'+baseUrl+'/assets/images/flecha-rosa.png 1x, '+baseUrl+'/assets/images/flecha-rosa@2x.png "media="(min-width: 315px)"><img class="flecha-izquierda" src="'+baseUrl+'/assets/images/flecha-rosa.png" alt="icon-flecha"></picture>';
    var flechaDerHtml = '<picture><source srcset="'+baseUrl+'/assets/images/flecha-rosa.svg" type="image/svg+xml"><source srcset="'+baseUrl+'/assets/images/flecha-rosa.png 1x, '+baseUrl+'/assets/images/flecha-rosa@2x.png "media="(min-width: 315px)"><img class="flecha-derecha" src="'+baseUrl+'/assets/images/flecha-rosa.png" alt="icon-flecha"></picture>';
...
function getInstagram() {
    ...
    if (window.innerWidth > 960 ) {
        var scripttoLoad = '<script src="https://cdn.lightwidget.com/widgets/lightwidget.js"></script><iframe src="//lightwidget.com/widgets/02a084dc887b54b39e3e3e9794f92a09.html" scrolling="no" allowtransparency="true" class="lightwidget-widget" style="width:100%;border:0;overflow:hidden;"></iframe>';
