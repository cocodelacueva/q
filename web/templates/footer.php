	<footer class="main-footer">
		...
		<div class="legales-wrapper">
			...
			<div class="legales">
				<h4>Q ES MARCA REGISTRADA DE AUCKLAND TURISMO SRL.</h4>
				<p>
					Q es una marca de productos para jovenes de Auckland Turismo S.R.L EVyT Leg Nro. 12.278 Disp. 106/06
				</p>
