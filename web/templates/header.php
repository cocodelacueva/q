...
<head>
	...
	<link rel="mask-icon" href="/safari-pinned-tab.svg" color="#6459b0">
	<meta name="msapplication-TileColor" content="#6459b0">
	<meta name="theme-color" content="#6459b0">
...
<div class="main-wrapper">
	...
	<header class="main-header">
		<nav class="navbar">
			...
			<p class="tagline">Tus 15 en Disney</p>
				...
				<ul>
					<li>
						<a class="btn-icon-left scroll-to" href="<?php echo MAINSURL;?>/#viajo">
							<picture>
								<source srcset="<?php echo IMAGES; ?>mickey-icon-white.svg" type="image/svg+xml">
								<source srcset="<?php echo IMAGES; ?>mickey-icon-white.png 1x, <?php echo IMAGES; ?>mickey-icon-white@2x.png 2x" media="(min-width: 315px)">
								<img src="<?php echo IMAGES; ?>mickey-icon-white.png" alt="Icon Whatsapp">
							</picture>
							Yo viajo 
						</a>
					</li>
